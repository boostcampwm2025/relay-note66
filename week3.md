...
학습을 계속하다 보면 어느 순간 내가 정말 제대로 이해하고 있는지 확신이 서지 않을 때가 많습니다.  
스스로 질문을 만들어보기도 했지만, 이미 답을 알고 있는 상태에서 만들다 보니 객관적인 평가가 어렵다는 한계를 느꼈습니다.  
그래서 내가 학습한 내용을 바탕으로 AI가 생성한 퀴즈를 통해 직관적으로 이해도를 점검하고, 스스로에 대한 정확한 평가를 하고자 이 방법을 선택하게 되었습니다.
